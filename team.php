...
<!-- team start ................ -->
  ...
  <section class="container team">
        ...
        <div class="teamcard">
          ...
          <div class="teamcontent">
            ...
            <div class="div">
              ...
              <a href="#" target="_blank"><i class="fab fa-behance fa-2x mx-2"></i></a>
              <a href="#" target="_blank"><i class="fab fa-github fa-2x mx-2"></i></a>
              <a href="#" target="_blank"><i
    ...
    <div class="col-lg-4 col-md-4 col-sm-6">
        <div class="teamcard">
          <div class="teamimgbox four">
            <div class="teamimage"></div>
          </div>
          <div class="teamcontent">
            <h3>Joel Thalakottur</h3>
            <b>Web Designer & Web Developer</b>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore, dolore.</p>
            <div class="div">
              <a href="#"><i class="fab fa-facebook-square fa-2x mx-2"></i></a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            ...
            <p>BookMyBus is a premium online booking portal which allows you to purchase tickets for various bus
  ...
  <div class="container-fluid">
    <div class="row lastpart">
      <h4>© 2021 BookMyBus. All rights reserved.<a style="color:#e7e7e7" ;
          href="" target="_blank"></a></h4>
    </div>
  </div>
  <!-- footer end ...................... -->
